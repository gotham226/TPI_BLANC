...
if(isset($_POST['supprimer'])){
	...
	unlink('./img/'.$cap['image']);
		
    

    DeleteCap($_GET['idCap']);
    header('Location: index.php');
    exit;
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Supprimer une casquette</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Page admin suppression de produit</p>
                </div>
            </div>
        </header>
        <!-- Section-->
            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <form action="#" method="post">
                        <label for="suppression">Etes-vous sur de vouloir supprimer cet casquette ?</label>
                        <br></br>
